...
Route::group(['namespace' => 'Admin','prefix' => 'admin'], function (){
    ...
    Route::middleware(['auth:admin','rbac'])->group(function (){
        ...
        Route::post('admin/create','PosController@create')->name('pos.create');

        Route::post('admin/update_status','PosController@UpdateStatus')->name('pos.UpdateStatus');

        Route::get('admin/flavor','FlavorController@index')->name('flavor.index');

        Route::get('admin/order_detail','PosController@getOrderDetail')->name('pos.OrderDetail');
    });
});
